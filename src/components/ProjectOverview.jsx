 ...
 const projects = [
  {
    id: 1,
    name: 'Project 1',
    description: 'This is project one and project one is project one',
    languages: [
      { name: 'yoruba' },
      { name: 'yoruba' },
      { name: 'yoruba' },
...
const [filter, setFilter] = useState('all')
  ...
  return (
    <div className='w-[100vw] h-fit py-[2rem] bg-light flex flex-col items-center lg:px-[10%] px-[1rem]'>
...
{/* 
      ...
      <div className='grid gap-[2rem] lg:grid-cols-2 grid-cols-1'>
        {
          projects.map((item) => (
            <div className='p-6 bg- rounded-2xl'>

              <img src={item.image} alt="image" className='md:w-[30rem] w-[100%] h-auto bg-secondary p-3'/>
              <div className='mt-[1.5rem]'>
                <div className='flex flex-row justify-between'>
                  ...
                  <a href="/" target='_blank' className='hover:text-black cursor-pointer'><AiFillGithub /></a>
                <a href="/" target='_blank' className='hover:text-black cursor-pointer'><FaShare className='font-bold '/> </a>
                  </div>
                </div>

              
              <div className='flex flex-row flex-wrap gap-[1rem] mt-[.5rem]'>
              {
                item.languages.map((language) => (
